...
function usa_html5map_plugin_scripts(){
    if ( is_admin() ){
        ...
        wp_register_style('usa-html5-map-adm', plugins_url('/static/css/mapadm.css', __FILE__), array(), 'r3.2.6');
        wp_enqueue_style('usa-html5-map-adm');
        wp_register_style('usa-html5-map-style', plugins_url('/static/css/map.css', __FILE__), array(), 'r3.2.6');
...
function usa_html5map_plugin_content($atts, $content) {
    ...
    wp_register_script('raphaeljs', usa_html5map_plugin_get_raphael_js_url(), array(), 'r3.2.6');
    wp_register_script('usa-html5-map-mapjs_'.$type_id, usa_html5map_plugin_get_map_js_url($options), array('raphaeljs'), 'r3.2.6');
    ...
    if ($options['useAjaxUrls']) {
        ...
        usa_html5map_plugin_popup_builder_enable_scripts($options, $states);
        $popupUrl = "{$siteURL}/index.php?map_id={$map_id}&usahtml5map_get_popup";
        $stateInfoUrl = "{$siteURL}/index.php?map_id={$map_id}&usahtml5map_get_state_info=";
        $groupInfoUrl = "{$siteURL}/index.php?map_id={$map_id}&usahtml5map_get_group_info=";
    }
