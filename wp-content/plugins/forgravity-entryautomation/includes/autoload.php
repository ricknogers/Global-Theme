...
/**
 * Autoload Entry_Automation class files.
...
$autoloader->add_namespace( 'ForGravity\\Entry_Automation\\', dirname( __DIR__ ) . '/includes/' );
$autoloader->add_namespace( 'ForGravity\\Entry_Automation\\Legacy\\', dirname( __DIR__ ) . '/legacy/includes/' );
$autoloader->register();
