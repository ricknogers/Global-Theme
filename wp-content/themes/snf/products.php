...
get_header(); ?>
    <div class="container  ">
        <?php if( !flrt_is_filter_request() ):?>
            <div class="row products_decision_title_steps">
                <div class="col">
                    <h2>Find Products by Market:</h2>
                </div>
            </div>
            <div class="row products_markets_decisions">
                <?php
        ...
        <?php else:?>
            <div class="row filtered_products">
