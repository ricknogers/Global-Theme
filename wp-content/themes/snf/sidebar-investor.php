	        ...
	        <?php if ( $esg_pdf_link ) : ?>
                <li class="list-group-item">
                    <a target="_blank" href="<?php echo $esg_pdf_link;?>">
                        ...
                        <img src="https://www.snf.com/wp-content/uploads/2021/03/ESG-Report-Cover-EN_Page_01-1.jpg" class="img-fluid" />
                    </a>
                </li>
	        <?php endif; ?>
            <li class="list-group-item">
                ...
                <a target="_blank" href="<?php echo $code_conduct;?>">
                    ...
                    <img src="https://www.snf.com/wp-content/uploads/2021/03/Simple-SNF-Responsible-Chemistry-Simplified-ENG-WEB-scaled-1.jpg" class="img-fluid" />

                </a>
            </li>

        </ul>
        <a class="btn btn-outline-primary btn-default btn-block my-3" href="<?php echo home_url('/');?>investors-center/">
            Back to Investors
        </a>
    </section>
</aside><!--newsSideBar-->
