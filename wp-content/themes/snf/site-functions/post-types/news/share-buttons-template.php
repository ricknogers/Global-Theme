<div>
    <ul class="share-buttons">
        ...
        <li>
            <a class="share-email" href="mailto:type%20email%20address%20here?subject=<?php the_title(); ?>&body=<?php the_title(); ?> - <?php the_permalink(); ?>" title="Email to a friend/colleague" target="_blank">
