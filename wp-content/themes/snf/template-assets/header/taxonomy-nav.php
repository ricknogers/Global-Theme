<?php if(is_tree('80431')):?> <?php // if page is decendent of /industry page ;?>
    <div class=" " id="custom-tax-second-nav">
        ...
        <div class=" second-tier-nav subsidiary-children-pages  h-100 " style="<?php foreach($terms as $term) :?><?php $breadcrumbsColor = get_field('color_scheme', $term->taxonomy . '_' . $term->term_id);?>background-color:<?php echo $breadcrumbsColor;?><?php endforeach; ?>">
