...
<?php if (get_sub_field( 'card_layout' ) == 'card-slider' ) : ?>
    <div id="markets_carousel" class="carousel slide w-100 mt-3 mb-3 " data-ride="carousel">
		<div class="row mb-3">
                            ...
                            <article class="postcard light blue">
                                ...
                                <?php if ( $button_link ) : ?>
                                    <a class="postcard__img_link" href="<?php echo esc_url( $button_link); ?>">
										...
										<?php else:?>
							                <?php if (get_sub_field( 'image_type' ) == 'responsive-image' ) : ?>
													<img class=" postcard__img  postcard__img" src="<?php echo $image['url']; ?>" alt="<?php echo $image['title']; ?>">
							                <?php endif;?>
						                <?php endif;?>
                                    </a>
                                <?php else:?>
                            ...
                            <article class="postcard light blue">
                                ...
                                <?php if ( $button_link ) : ?>
                                    <a class="postcard__img_link" href="<?php echo esc_url( $button_link); ?>">
                                        <?php $image = get_sub_field('image');?>
                                        <?php if (get_sub_field( 'image_type' ) == 'background-image' ) : ?>
			                                <div class="bg_image_card  postcard__img" style="background-image: url(<?php echo $image['url']; ?>)"></div>
										<?php else:?>
							                <?php if (get_sub_field( 'image_type' ) == 'responsive-image' ) : ?>
